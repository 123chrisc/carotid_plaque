...
matches <- apply(interaction_db, 1, function(row) {
  contains_any_gene(row["ligand"], pm_genes)
})
...
svg("images/cellchat/signaling_pathways_EV_plaque.svg", width=20, height=16)
ht2
dev.off()
...
svg("images/cellchat/chord_EV_Plaque_EC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_Plaque_VSMC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_Plaque_Macrophage.svg", width=10, height=8)
