...
matches <- apply(interaction_db, 1, function(row) {
  contains_any_gene(row["ligand"], s_pm_genes)
})
...
svg("images/cellchat/signaling_pathways_symp_plaque.svg", width=20, height=16)
ht2
dev.off()
...
svg("images/cellchat/chord_EV_symp_plaque_EC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_symp_plaque_VSMC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_symp_plaque_Macrophage.svg", width=10, height=8)
