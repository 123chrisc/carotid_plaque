...
matches <- apply(interaction_db, 1, function(row) {
  contains_any_gene(row["ligand"], a_pm_genes)
})
...
svg("images/cellchat/signaling_pathways_asymp_plaque.svg", width=20, height=16)
ht2
dev.off()
