...
svg("images/cellchat/signaling_pathways_EV_marginal.svg", width=20, height=16)
ht2
dev.off()
...
svg("images/cellchat/chord_EV_marginal_EC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_marginal_VSMC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_marginal_Macrophage.svg", width=10, height=8)
