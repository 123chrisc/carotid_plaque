...
matches <- apply(interaction_db, 1, function(row) {
  contains_any_gene(row["ligand"], s_mp_genes)
})
...
svg("images/cellchat/signaling_pathways_symp_marginal.svg", width=20, height=16)
ht2
dev.off()
...
netVisual_chord_gene(object, net = net,
                     sources.use = c("EC_1","EC_2",'EC_3'),
...
svg("images/cellchat/chord_EV_symp_marginal_EC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_symp_marginal_VSMC.svg", width=10, height=8)
...
svg("images/cellchat/chord_EV_symp_marginal_Macrophage.svg", width=10, height=8)
